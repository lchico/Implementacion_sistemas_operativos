...
int32_t getNextContext(int32_t actualContext)
{
	...
	/* si llegamos a este punto, error en la pol��tica de scheduling!!! */
	while(1);
}

void return_hook(void)
{
	/* por si una tarea ejecuta return, vengo ac�� */
	while(1);
}
		...
		void * parameter /* parametro de la tarea */)
{
	...
	/* pen��ltimo elemento: LR (return hook) ======= PROBARRRRR QUE PASAAA!!!!!!! LUIS CHICO */
